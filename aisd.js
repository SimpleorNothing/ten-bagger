...
<div class="ds-card">
  ...
  <div class="ds-fn">채워진 막대=실적 · 테두리=추정(E) · 점선=컨센서스 희박 · 라인 <span style="color:var(--st-dawn)">&#9473; 매출</span>·<span style="color:var(--st-hot)">&#9473; FCF</span> — <b>막대·라인 전부 동일 $축</b>(상한 ~$2.55T) · 실선=실적·점선=추정, 26E FCF ~0은 MS·BofA·Epoch 컨센(AMZN 마이너스·GOOGL ~$8B) · 리비전 트랙은 캡처 축적 전 예시 — 연동 시 분기 스냅샷 비교로 자동 파생</div>
</div>
