...
<div class="ds-topcharts" aria-label="컴퓨팅 판매자 핵심 지표 차트">
  ...
  <section class="ds-topchart wide">
    ...
    <div class="ds-topfn">단위 $B · RPO=연말 잔액 · 매출=AWS+Microsoft Cloud+Google Cloud · CAPEX=Amazon+Microsoft+Alphabet 전사 기준 · 2026E 이후 전망치는 Base Case이며 실적과 구분해 E 표기로 표시 · 꺾은선 그래프 · 단일 축(0~3,000B)</div>
  </section>
</div>
