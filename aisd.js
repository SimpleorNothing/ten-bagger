...
var HTML=`<div style="position:relative">
  <div class="ds-kick">AI Demand · Supply · 수요·공급 로드맵</div>
  <h2 class="ds-title">AI <em>수요·공급</em> — 연도별 계획으로 보는 상류·병목</h2>
  <div class="ds-upd">update : 2026.07.17 · 컨센서스 방향성 추정 · 수동 갱신(분기 캡처) · 리비전 트랙은 캡처 축적 전 예시</div>
</div>
...
<div class="ds-sec">AI의 진화 <span class="ds-note">방향만 · 추정 · 연도는 대략치</span></div>
<div class="ds-lens">
...
<div class="ds-sec">하이퍼스케일러 CAPEX <span class="ds-note">4사 합산 · $B · 2027E &gt;$1T · 2028E 애널 추정(컨센서스 희박)</span></div>
<div class="ds-lens">
...
<div class="ds-sec">주요 업체 투자계획 <span class="ds-note">수요 · 연도별 CAPEX · $B · 업체 클릭 = 연도별 상세</span></div>
<div class="ds-lens">
...
<div class="ds-sec">주요 업체 캐파 투자계획 <span class="ds-note">공급 · 메모리 3사 · HBM/DRAM 중심 · 투자 사이클 2027까지 연장</span></div>
<div class="ds-lens">
...
<div class="ds-sec">중국 업체 확대 계획 <span class="ds-note">공급 · CXMT·YMTC·SMIC · 캐파 2배 시도 · 선단 격차 존재</span></div>
<div class="ds-lens">
