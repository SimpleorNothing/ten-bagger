...
<div class="ds-card">
  <div class="ds-bars" style="position:relative;height:510px">
    ...
    <div class="ds-bc"><span class="ds-bv"><span style="font-size:10px;color:var(--dim)">+53%</span><br>$230B</span><div class="ds-bar" style="height:9%"></div></div>
    <div class="ds-bc"><span class="ds-bv"><span style="font-size:10px;color:var(--dim)">+100%</span><br>$460B</span><div class="ds-bar" style="height:18.1%"></div></div>
    <div class="ds-bc"><span class="ds-bv"><span style="font-size:10px;color:var(--dim)">+52%</span><br>~$700B</span><div class="ds-bar est" style="height:27.5%"></div></div>
    <div class="ds-bc"><span class="ds-bv"><span style="font-size:10px;color:var(--dim)">+43%</span><br>&gt;$1,000B</span><div class="ds-bar est" style="height:39.2%"></div></div>
    <div class="ds-bc"><span class="ds-bv"><span style="font-size:10px;color:var(--dim)">+20%</span><br>~$1,200B</span><div class="ds-bar est" style="height:47.1%;border-style:dashed"></div></div>
    <svg viewBox="0 0 600 182" preserveAspectRatio="none" aria-hidden="true" style="position:absolute;left:0;top:0;width:100%;height:100%;overflow:visible;pointer-events:none"><polyline points="50,93 150,81 250,66" fill="none" stroke="var(--st-dawn)" stroke-width="2" stroke-opacity=".9" vector-effect="non-scaling-stroke"/><polyline points="250,66 350,50 450,32 550,11" fill="none" stroke="var(--st-dawn)" stroke-width="2" stroke-opacity=".9" stroke-dasharray="5 4" vector-effect="non-scaling-stroke"/><polyline points="50,167 150,166 250,170" fill="none" stroke="var(--st-hot)" stroke-width="2" stroke-opacity=".9" vector-effect="non-scaling-stroke"/><polyline points="250,170 350,180 450,181" fill="none" stroke="var(--st-hot)" stroke-width="2" stroke-opacity=".9" stroke-dasharray="5 4" vector-effect="non-scaling-stroke"/><circle cx="50" cy="93" r="3.5" fill="var(--st-dawn)"/><circle cx="150" cy="81" r="3.5" fill="var(--st-dawn)"/><circle cx="250" cy="66" r="3.5" fill="var(--st-dawn)"/><circle cx="350" cy="50" r="3.5" fill="var(--panel2)" stroke="var(--st-dawn)" stroke-width="1.5"/><circle cx="450" cy="32" r="3.5" fill="var(--panel2)" stroke="var(--st-dawn)" stroke-width="1.5"/><circle cx="550" cy="11" r="3.5" fill="var(--panel2)" stroke="var(--st-dawn)" stroke-width="1.5"/><circle cx="50" cy="167" r="3.5" fill="var(--st-hot)"/><circle cx="150" cy="166" r="3.5" fill="var(--st-hot)"/><circle cx="250" cy="170" r="3.5" fill="var(--st-hot)"/><circle cx="350" cy="180" r="3.5" fill="var(--panel2)" stroke="var(--st-hot)" stroke-width="1.5"/><circle cx="450" cy="181" r="3.5" fill="var(--panel2)" stroke="var(--st-hot)" stroke-width="1.5"/><polyline points="50,163 150,156 250,151" fill="none" stroke="var(--st-mature)" stroke-width="2" stroke-opacity=".9" vector-effect="non-scaling-stroke"/><polyline points="250,151 350,146 450,142" fill="none" stroke="var(--st-mature)" stroke-width="2" stroke-opacity=".9" stroke-dasharray="5 4" vector-effect="non-scaling-stroke"/><circle cx="50" cy="163" r="3.5" fill="var(--st-mature)"/><circle cx="150" cy="156" r="3.5" fill="var(--st-mature)"/><circle cx="250" cy="151" r="3.5" fill="var(--st-mature)"/><circle cx="350" cy="146" r="3.5" fill="var(--panel2)" stroke="var(--st-mature)" stroke-width="1.5"/><circle cx="450" cy="142" r="3.5" fill="var(--panel2)" stroke="var(--st-mature)" stroke-width="1.5"/></svg>
    <span style="position:absolute;left:8.3%;top:51.1%;transform:translate(-50%,-130%);font-family:var(--mono);font-size:10px;color:var(--st-dawn);white-space:nowrap;pointer-events:none">$1.25T</span><span style="position:absolute;left:25.0%;top:44.5%;transform:translate(-50%,-130%);font-family:var(--mono);font-size:10px;color:var(--st-dawn);white-space:nowrap;pointer-events:none">$1.42T</span><span style="position:absolute;left:41.7%;top:36.3%;transform:translate(-50%,-130%);font-family:var(--mono);font-size:10px;color:var(--st-dawn);white-space:nowrap;pointer-events:none">~$1.62T</span><span style="position:absolute;left:58.3%;top:27.5%;transform:translate(-50%,-130%);font-family:var(--mono);font-size:10px;color:var(--st-dawn);white-space:nowrap;pointer-events:none">~$1.85T</span><span style="position:absolute;left:75.0%;top:17.6%;transform:translate(-50%,-130%);font-family:var(--mono);font-size:10px;color:var(--st-dawn);white-space:nowrap;pointer-events:none">~$2.1T</span><span style="position:absolute;left:91.7%;top:6.0%;transform:translate(-50%,-130%);font-family:var(--mono);font-size:10px;color:var(--st-dawn);white-space:nowrap;pointer-events:none">~$2.4T</span>
    <span style="position:absolute;left:25.0%;top:44.5%;transform:translate(-50%,-250%);font-family:var(--mono);font-size:9px;color:var(--dim);white-space:nowrap;pointer-events:none">+14%</span><span style="position:absolute;left:41.7%;top:36.3%;transform:translate(-50%,-250%);font-family:var(--mono);font-size:9px;color:var(--dim);white-space:nowrap;pointer-events:none">+14%</span><span style="position:absolute;left:58.3%;top:27.5%;transform:translate(-50%,-250%);font-family:var(--mono);font-size:9px;color:var(--dim);white-space:nowrap;pointer-events:none">+14%</span><span style="position:absolute;left:75.0%;top:17.6%;transform:translate(-50%,-250%);font-family:var(--mono);font-size:9px;color:var(--dim);white-space:nowrap;pointer-events:none">+14%</span><span style="position:absolute;left:91.7%;top:6.0%;transform:translate(-50%,-250%);font-family:var(--mono);font-size:9px;color:var(--dim);white-space:nowrap;pointer-events:none">+14%</span>
  </div>
