...
<div class="ds-topcharts" aria-label="컴퓨팅 판매자 핵심 지표 차트">
  <section class="ds-topchart wide">
    ...
    <div class="ds-topfn"><span style="color:#315b78">■ Microsoft</span> · <span style="color:#5f86a0">■ Amazon</span> · <span style="color:#9bb5c5">■ Alphabet</span> · 좌측 축=공개 수주잔고(최대 2.00T · 0.50T 간격) · 우측 축=클라우드 서비스 매출·CAPEX(최대 300B · 100B 간격) · 매출·CAPEX는 3사 합산, 수주잔고는 3사 모두의 분기 공개액이 있을 때만 합산(AWS 26.1Q $364B·26.2Q $496B) · 하나라도 미공개면 수주잔고는 ‘없음’ · 수주잔고 괄호=3사 연환산 매출 대비 배수 · 매출 괄호=3사 매출 가중 영업이익률(Microsoft는 Intelligent Cloud 부문 실적 기준)</div>
  </section>
</div>
...
function mountQuarterlyCloudChart(root){
 ...
 var d={years:['24.1Q','24.2Q','24.3Q','24.4Q','25.1Q','25.2Q','25.3Q','25.4Q','26.1Q','26.2Q'],backlog:[null,null,null,null,null,null,null,null,1455,1688],revenue:[70,73,78,82,84,91,97,105,114,126],capex:[36,45,52,61,68,75,88,105,145,150],opMargin:[35,34,36,35,37,35,36,40,40,39],companies:[{name:'Microsoft',color:'#315b78',share:{backlog:[null,null,null,null,null,null,null,null,.431,.402],revenue:[.503,.501,.500,.501,.505,.514,.505,.491,.479,.470],capex:[.31,.31,.31,.31,.32,.32,.32,.32,.30,.28]}},{name:'Amazon',color:'#5f86a0',share:{backlog:[null,null,null,null,null,null,null,null,.250,.294],revenue:[.357,.360,.354,.352,.349,.340,.339,.340,.334,.335],capex:[.42,.42,.42,.42,.41,.41,.41,.41,.43,.39]}},{name:'Alphabet',color:'#9bb5c5',share:{backlog:[null,null,null,null,null,null,null,null,.319,.305],revenue:[.140,.139,.146,.147,.146,.146,.156,.169,.187,.195],capex:[.27,.27,.27,.27,.27,.27,.27,.27,.27,.33]}}]},ctx=canvas.getContext('2d'),active=-1;
