...
window.INSIGHT=(function(){
 ...
 function mount(){
  ...
  /* 04 시장과 실적 전망(v-thread) 뷰 제목을 탭 개명과 정합 — index.html 무편집(자가 마운트).
     구 「지금 궁금한 것 — 바로 보는 답」 → 「시장과 실적 전망 — 바로 보는 답」. SimpleorNothing 지시 2026-07-18. */
  var vt=document.querySelector('#v-thread .vtitle');
  if(vt&&/궁금한 것/.test(vt.textContent))vt.innerHTML='시장과 실적 전망 — <em>바로 보는 답</em>';
