// 뉴스 물질성 스크리너 · MV=2  (scripts/fetch-news.mjs 가 import)
//
...
export const SIG_TERMS_EN = '(guidance OR earnings OR capex OR contract OR order OR backlog OR "supply deal" OR pricing OR shipment OR qualification OR "design win" OR capacity)';
export const SIG_TERMS_KO = '(실적 OR 가이던스 OR 수주 OR 계약 OR 공급 OR 증설 OR 가동 OR 양산 OR 수율 OR 캐파)';
