...
- **m=1 리비전·수급 실사건**: 애널리스트 목표가·투자의견·추정치 변경, 지수 편출입, 대량보유·내부자 지분 공시, 자사주·증자. 이 등급은 기록에는 남기되 종목 뉴스 화면에는 표시하지 않는다.
...
- 종목 뉴스 화면에는 m=2만 표시한다. 향후 6~18개월의 매출·마진·수주·CAPEX·공급·제품 경쟁력·규제에 연결되지 않는 기사는 m=0 또는 m=1로 분류한다. 애매하면 m=1.`;
...
export const BOTTLENECK_TOPICS = [
  { id: 'bneck_l3_dram', ticker: 'MACRO', name: 'L3 · DRAM/HBM 가격·공급', q: 'DRAM 고정거래가 HBM 공급 계약', mkt: 'KOSPI', ax: 'bn_l3_dram' },
