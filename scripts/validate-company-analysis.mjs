...
if(!company.includes('quarterlyHtml(d.quarterly')||!company.includes('annualRows(financials)')||!company.includes('data-ca-period-toggle')||!company.includes("alpha_company_period")||!company.includes('연간별')||!company.includes('ca-qchart')||!company.includes('ca-q-plot')||!company.includes('ca-q-yaxis')||!company.includes('ca-q-columns')||!company.includes('ca-q-zero')||!company.includes('ca-q-negative')||!company.includes('분기별')||!company.includes('ca-q-bar-rev')||!company.includes('ca-q-bar-op')||!company.includes('분기 실적·전망')||!company.includes('GAAP · $B'))fail('quarterly/annual grouped bar-chart toggle renderer missing');
