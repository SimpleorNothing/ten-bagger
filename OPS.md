...
*마지막 갱신: 2026-05-30 · 메뉴 8탭(02 투자 캘린더 신설, `v-cal` 정적 일정 관제: 거시·실적·이벤트·워치) · 01 매크로 매매(signals.json) · 07 X-레이에 TARGETS 적정밴드·회전 갭표 추가, xrayHero/portSub HOLDINGS 구동 동기화 · 가장 임박 실무: MU 6/25 (hist ±6.5%, 6/18경 event-iv 갱신) · MRVL 5/27 경과로 제거*
