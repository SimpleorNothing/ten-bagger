...
> 2026-08-02 11:20 · **04 시장과 실적 전망 최상단 핵심 차트 3종 추가.** `aisd.js`가 ① 4사(Amazon·Microsoft·Alphabet·Meta) 매출·CAPEX·영업이익·FCF를 하단 상세 차트와 같은 데이터로 한 번 더 렌더한다. ② 클라우드 서비스 매출과 ③ 클라우드 수주잔고는 Meta를 제외한 AWS·Azure·GCP 및 MSFT 상업 RPO·AWS RPO·Google Cloud 잔고를 각각 합산해 표시한다. 수주잔고는 회사별 최신 공시 시점 차이를 각주에 명시한다.
