...
> 2026-08-02 11:30 · **04 시장과 실적 전망 최상단 차트를 분기 통합형으로 변경.** `aisd.js`가 2024.1Q~2026.2Q의 Amazon·Microsoft·Alphabet 3사 기준 수주잔고·클라우드 서비스 매출·CAPEX를 하나의 그래프로 표시한다(Meta 제외). 매출 라벨의 괄호는 수주잔고 대비 비율, CAPEX 라벨의 괄호는 매출 대비 비율이다. 수주잔고는 MSFT 상업 RPO·AWS RPO·Google Cloud 잔고 합산이며, AWS 1Q26 공시 기준과 OpenAI 신규 $100B 제외를 각주에 명시한다.
