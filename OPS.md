**최종 갱신: 2026-08-02 16:45 (KST)**

# OPS — 알파맵 운영 가이드

> 2026-08-02 16:45 · **개인 투자 분석 원칙 지시문 반영.** 투자 분석은 source 파일의 최신 보유종목·평가금액·비중을 우선 확인하고, AI 인프라 연결 구조·중복 노출·실적 검증을 기준으로 판단한다. 종목 뉴스와 비중조절 의견의 필수 형식도 `CLAUDE.md`에 명문화했다.
