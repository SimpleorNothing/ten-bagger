...
(function(){
  var MENU_LAST={
    market:'2026-08-01', insight:'2026-07-31', council:'2026-08-01',
    thread:'2026-07-31', decision:'2026-07-31', brief:'2026-07-31', memo:'2026-07-31'
  };
  var MKT_CHANGELOG=[
    {d:'2026-08-01',t:'03 전문가 원탁 토론 이력의 최대 20건 제한 제거 — 삭제 전까지 모든 이력을 서버에 누적 보관'},
    {d:'2026-08-01',t:'03 전문가 원탁의 council.json SoT 중복 블록 직접 로드 경로 제거 — 기본 토론 이력만 표시'},
    {d:'2026-08-01',t:'01 미국 지수·미 10년물·WTI 등 장 마감 데이터 갱신을 06:05 KST 1차 실행과 06:35 KST 재시도로 보강'},
    {d:'2026-08-01',t:'03 전문가 원탁의 council.json SoT 중복 결과·이력 블록 제거, 토론 이력은 최대 20건 누적 보관으로 복원'},
